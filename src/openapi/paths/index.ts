...
import { userNotesByIdExport } from './api/v1/user-notes-note-id-export';
import { userNotesImport } from './api/v1/user-notes-import';
...
export const paths: OpenAPIV3.PathsObject = {
  ...
  '/api/v1/user/notes/import': userNotesImport,
  '/api/v1/user/notes/{noteId}': userNotesById,
  '/api/v1/user/notes/{noteId}/export': userNotesByIdExport,
